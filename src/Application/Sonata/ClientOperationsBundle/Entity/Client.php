...
class Client
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Application\Sonata\ClientBundle\Entity\ListNatureDuClients", inversedBy="client")
     ...
     *
     * @ORM\ManyToOne(targetEntity="Application\Sonata\ClientBundle\Entity\ListModeDenregistrements", inversedBy="client")
     ...
     *
     * @ORM\ManyToOne(targetEntity="Application\Sonata\ClientBundle\Entity\ListPeriodiciteFacturations", inversedBy="client")
